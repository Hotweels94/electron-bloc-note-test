...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      contextIsolation: true, // Sépare les contextes JS du main et du renderer (sécurité)
      nodeIntegration: false, // Désactive l'accès direct à Node.js dans le renderer (sécurité)
    },
  });
